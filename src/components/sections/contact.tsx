      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mb-12 text-muted-foreground">
            Entre em contato para conversar sobre oportunidades, projetos ou colaborações.
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            >
              <Link
                ...
                className="flex flex-col items-center rounded-xl border border-border/50 bg-card/50 p-6 backdrop-blur-sm transition-all hover:shadow-md"
              >
                <GitHubIcon />
            ...
            >
              <Link
                href="mailto:carlos@exemplo.com"
                className="flex flex-col items-center rounded-xl border border-border/50 bg-card/50 p-6 backdrop-blur-sm transition-all hover:shadow-md"
              >
