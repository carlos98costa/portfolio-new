              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    {project.imageUrl ? (
                      <div className="relative mb-7 h-56 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035]">
                        <Image
                      ...
                      <div className={`mb-7 flex h-56 items-center justify-center rounded-3xl border border-white/10 ${accent.bg}`}>
                        <div className="text-center">
                          <Icon className={`mx-auto h-12 w-12 ${accent.text}`} />
                          <p className="mt-3 text-sm font-medium text-zinc-400">Case sem imagem pública</p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="mb-7 flex items-start justify-between gap-5">
                      ...
                      <div className={`hidden h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-white/10 ${accent.bg} ${accent.text} sm:flex`}>
